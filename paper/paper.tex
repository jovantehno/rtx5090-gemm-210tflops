...
\begin{figure}[t]
    ...
    \caption{GEMM optimization progression on RTX 5090 ($4096^3$ FP16). Starting from 7 TFLOPS, successive optimizations yield 210 TFLOPS (92\% of cuBLAS).}
...
\begin{itemize}
    ...
    \item Full combination: 210 TFLOPS (92\% of cuBLAS)
\end{itemize}
...
Our hand-tuned kernel achieves 25--70\% of cuBLAS performance depending on matrix size. The combined optimized kernel achieves 92\% of cuBLAS at $4096^3$.
...
\textbf{Limitations:} Single GPU (no A100/H100 for direct comparison); compatibility mode; square matrices only.

\textbf{Future Work:} Native Blackwell kernels with TMA; non-square matrices; adaptive stride selection; multi-architecture comparison.
...
Our hand-tuned kernels achieve up to 92\% of cuBLAS performance despite running in compatibility mode. We release our benchmark suite at: \url{https://github.com/jovantehno/rtx5090-gemm-210tflops}
