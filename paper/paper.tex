...
Further optimization using PTX-level techniques (Example 09) achieves \textbf{1.07$\times$ speedup over cuBLAS}:
...
\noindent\textit{Note: Results from 2000-iteration benchmarks to ensure stable measurements.}
...
\begin{tabular}{@{}crrrc@{}}
\toprule
\textbf{Size} & \textbf{MB} & \textbf{L2 Cov.} & \textbf{Sens.} & \textbf{Speedup} \\
\midrule
$512^3$ & 1.5 & 100\% & 1.5\% & 1.01$\times$ \\
$1024^3$ & 6 & 100\% & 0.2\% & 1.00$\times$ \\
$2048^3$ & 24 & 100\% & 11.9\% & 1.08$\times$ \\
$4096^3$ & 96 & 100\% & 10.5\% & 1.12$\times$ \\
$8192^3$ & 384 & 25\% & 7.9\% & 1.03$\times$ \\
$16384^3$ & 1536 & 6\% & 2.4\% & 1.02$\times$ \\
\bottomrule
\end{tabular}
\end{table}
